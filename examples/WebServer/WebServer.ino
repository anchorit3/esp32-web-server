// @file WebServer.ino
// @brief Example implementation using the ESP32 WebServer.
//
...
class FileServerHandler : public RequestHandler {
  public:
    ...
    bool handle(ESP32WebServer &server, HTTPMethod requestMethod, const String &requestUri) override {
    ...
    // uploading process
    void upload(ESP32WebServer UNUSED &server, const String UNUSED &_requestUri, HTTPUpload &upload) override {
      // ensure that filename starts with '/'
