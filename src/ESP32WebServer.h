...
{
public:
  ESP32WebServerTemplate(IPAddress addr, int port = 80);
  ESP32WebServerTemplate(int port = 80);
...
#include "ESP32WebServer-impl.h"
#include "Parsing-impl.h"

using ESP32WebServer = ESP32webserver::ESP32WebServerTemplate<WiFiServer>;
using RequestHandler = ESP32webserver::RequestHandler<WiFiServer>;
